...
import { EventTemplate, TraitDefinition, LocationDefinition } from "src/types/index";
import { NarrativeCadence, EducatorArchetype, SubjectArchetype, TraitCategory } from "src/types/index";
...
export const EVENT_TEMPLATES: EventTemplate[] = [
    ...
    },
    {
        ...
        possibleChoices: [
            { id: "Choice_Eat_Quickly", choiceTextTemplate: "Eat quickly and avoid eye contact.", consequences: [{ statChanges: { traumaLevel: 2 } }] },
            { 
                id: "Choice_Stare_Back", 
                choiceTextTemplate: "Meet {Observer.name}'s gaze.", 
                consequences: [
                    { statChanges: { subjectAgencyBudget: 5 }, bondChanges: [{targetRole: 'Observer', change: 1}] },
                    { setMood: { role: 'Observer', mood: 'Amused' } }
                ] 
            },
            { id: "Choice_Talk_To_Peer", choiceTextTemplate: "Try to make small talk with {Peer.name}.", consequences: [{ bondChanges: [{targetRole: 'Peer', change: 2}] }] }
        ]
    },
    {
        ...
        possibleChoices: [
            { id: "Choice_Comply_Silently", choiceTextTemplate: "Perform the pointless task with grim determination.", consequences: [{ statChanges: { subjectAgencyBudget: -2 } }] },
            { id: "Choice_Question_Task", choiceTextTemplate: "Ask about the purpose of this task.", consequences: [{ statChanges: { subjectAgencyBudget: 5, shamePainAbyssLevel: 5 } }] },
        ]
    },
    {
        ...
        possibleChoices: [
            {
                ...
                consequences: [
                    { statChanges: { physicalIntegrity: -15, traumaLevel: 10, hopeLevel: -5 } },
                    { addTrait: 'STOIC' },
                    { updateWorldState: { forgeIntensityLevel: 52, magistraMood: 'Pleased' } }
                ]
            },
            {
                id: "Choice_Resist",
                ...
                consequences: [
                    { statChanges: { physicalIntegrity: -25, traumaLevel: 15, subjectAgencyBudget: 10 } },
                    { updateWorldState: { forgeIntensityLevel: 60, magistraMood: 'Angry' } }
                ]
            }
        ]
    },
    {
        ...
        possibleChoices: [
            { id: "Choice_Inspection_Endure", choiceTextTemplate: "Endure the suffocating scrutiny.", consequences: [{ statChanges: { traumaLevel: 15, subjectAgencyBudget: -10 }, updateWorldState: { magistraMood: 'Impatient' } }] },
            { id: "Choice_Inspection_Defy", choiceTextTemplate: "Meet the unseen gaze with a flicker of defiance.", consequences: [{ statChanges: { traumaLevel: 10, subjectAgencyBudget: 5 }, updateWorldState: { magistraMood: 'Intrigued' } }] },
        ]
    }
];
